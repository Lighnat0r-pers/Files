...
IniWrite, %PostUrl%, %SettingsFileName%, Options, Url To Post Results To
return
...
IniRead, PostUrl, %SettingsFileName%, Options, Url To Post Results To
return
...
gui, 2:Add, Text,c%TextColour% center w%WelcomeWindowWidth%, Welcome to the Points Checklist! - Master version
...
For Index, IconName in RequirementsArray
{
	...
	Request.Points.Insert(IconName, Object)
}
...
WebRequest.Open("POST", PostUrl, false)
...
Address10 := 0x008215F0 ; In The Beginning
...
MemoryValue := MemoryValue + Missions.ValueOld * Missions.PointsPer
